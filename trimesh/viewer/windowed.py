...
class SceneViewerWidget(pyglet.gui.WidgetBase):
    ...
    def __init__(self, 
        ...
        super(SceneViewerWidget, self).__init__(0, 0, resolution[0], resolution[1])
        # add scene geometry to viewer geometry
        self._update_vertex_list()
    ...
    def _update_node(self, node_name, geometry_name, geometry, transform):
        ...
        if self.vertex_list_hash.get(geometry_name) != geometry_hash_new:
            ...
            self.vertex_list_mode[geometry_name] = args[1]
