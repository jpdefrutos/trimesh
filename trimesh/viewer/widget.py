...
from .windowed import SceneViewer, SceneViewerWidget
...
class QtViewerWidget(QtOpenGL.QGLWidget):
    ...
    def __init__(self, scene, parent=None, frame_time=32, widget_size=(400, 300), viewer_opts={}):
        """
    ...
    def on_init(self):
        ...
        self.viewer = SceneViewerWidget(self.scene, resolution=(self.w, self.h), **self.viewer_opts)
